...
const SpeakerForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!formData.profile || !formData.name || !formData.bio) {
      mySwal.fire({
    ...
    try {
      ...
      await axios.post("https://192.168.201.124:5001/api/Speakers", data, {
        headers: {
      ...
      mySwal.fire({
        title: "Error",
        text: "Something went wrong while creating the speaker.",
        icon: "error",
      });
    }
  };
