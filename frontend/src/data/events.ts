...
export const eventsDummy: Event[] = [
  {
    ...
    venue: {
      ...
      location: "Dubai, UAE",
      rooms: [
        { id: 1, name: "Main Hall", capacity: 500 },
        { id: 2, name: "Conference Room A", capacity: 200 },
      ],
    },
    status: "Pending",
    description:
      "Conference or event where people in the technology industry gather to discuss, learn, and network about the latest trends, innovations, and challenges in the field",
    ticket: [
      { id: 1, type: "Standard" },
      { id: 2, type: "VIP" },
    ],
    sessions: [
      {
        ...
        speaker: {
          ...
          name: "Omar Hany",
          profile:
            "https://media.licdn.com/dms/image/v2/D4D03AQFXe-WnuwL6cA/profile-displayphoto-shrink_400_400/B4DZaiI.yOGcAg-/0/1746476986036?e=1758153600&v=beta&t=3oNO5rP6j49FOzTh6cLoNE4wXw0C4V8WqxQb2vaLm98",
  ...
  },
  {
    ...
    endTime: "",
    venue: {
      name: "Marriott Hotel, London",
      address: "456 High Street, London",
      location: "London, UK",
      rooms: [
        { id: 1, name: "Marketing Hall", capacity: 300 },
        { id: 2, name: "Strategy Room", capacity: 100 },
      ],
    },
    status: "Pending",
    sessions: [
  ...
  },
  {
    ...
    endTime : "",
    venue: {
      name: "Innovation Hub, Singapore",
      address: "789 Orchard Road, Singapore",
      location: "Singapore",
      rooms: [
        { id: 1, name: "AI Lab", capacity: 100 },
        { id: 2, name: "ML Workshop Room", capacity: 50 },
      ],
    },
    status: "Pending",
    sessions: [
  ...
  },
  {
    ...
    endTime : "",
    venue: {
      name: "Convention Center, New York",
      address: "456 Broadway, New York",
      location: "New York, USA",
      rooms: [
        { id: 3, name: "Blockchain Hall", capacity: 300 },
        { id: 4, name: "Crypto Room", capacity: 150 },
      ],
    },
    status: "Pending",
    sessions: [
